  ...
  return (
    <>
        ...
        <div className='max-w-[1200px] mx-auto my-24 p-4 flex flex-col md:flex-row items-center justify-center gap-14'>
            <div>
                <div className='bg-black'>
                    <img className='w-auto h-[50vh] object-cover opacity-95'
            ...
            <div>
                <div className='bg-black'>
                    <img className='w-auto h-[50vh] object-cover opacity-90'
            ...
            <div>
                <div className='bg-black'>
                    <img className='w-auto h-[50vh] object-cover opacity-95'
                    src="https://patiotime.loftocean.com/wp-content/uploads/2022/03/team-4.jpg" 
                    alt="Sous Chef" 
                    />
                </div>
